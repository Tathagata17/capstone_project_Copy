Feature: place order
  ...
  Scenario Outline: Placing order is successful
    ...
    Examples: 
      ...
      | medisettypravallika@gmail.com | Selenium@123 | Desktops | Build your own cheap computer | Fast  [+100.00] | 8 GB  [+60.00] | 400 GB  [+100.00] | Office Suite  [+100.00] | India   |  522503 | user1     | abc      | wipro   | hyd  | 7-143    | 1234567890 | Next Day Air | Cash On Delivery (COD) |
  ...
  Scenario Outline: Placing order is failed
    ...
    Examples: 
      ...
      | medisettypravallika@gmail.com | Selenium@123 | Desktops | Build your own cheap computer | Fast  [+100.00] | 8 GB  [+60.00] | 400 GB  [+100.00] | Office Suite  [+100.00] | India   |  522503 | user1     | abc      | wipro   | hyd  | 7-143    | 1234567890 | Next Day Air | Credit Card | Visa           | user1          | 4111111111111111 |          03 |       2028 |       12 |
